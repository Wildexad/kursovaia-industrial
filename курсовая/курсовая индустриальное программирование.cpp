...
int main()
{
    ...
    double A, B, C;
    int choice;
    cout << "Выберите один из типов уравнений:" << endl;
    cout << "1.Уравнение типа 0=0" << endl;
    cout << "2.Уравнение типа Ax^2=0" << endl;
    cout << "3.Уравнение типа С=0" << endl;
    cout << "4.Уравнение типа Ax^2+C=0 (методом подбора)" << endl;
    cout << "5.Уравнение типа Bx+C=0 (методом подбора)" << endl;
    cout << "6.Уравнение типа Ax^2+Bx+C=0 (через дискриминант и подбором)" << endl;
    cout << "7.Уравнение типа Bx=0" << endl;
    cout << "8.Уравнение типа Ax^2+Bx=0 (методом подбора)" << endl;
    cin >> choice;
    switch (choice) {
    case 1: {
